...
*/})
	...
	function crossDomainSubmit(item) {
		...
		// http://stackoverflow.com/questions/6580450/serialize-form-not-working-in-jquery
		// http://stackoverflow.com/questions/12815951/jquery-serialize-not-a-function
	...
	function createVideoPage(lang, pageId) {
		...
		if(!isKioskPro()) {
			...
			var player = "<div id='"+player_id+"' videoId='"+videos[lang][pageId].videoId+"' class='"+PlayerApi+"'></div>";
			page.append(player);
		...
		var tip = $(".videoTip",page);
		tip.html(tip.html()+"<img src='assets/images/up-arrow.png' />");
...
/*
  usage:
    <video src="../../js/example.ogg" id="examplevideo" />
